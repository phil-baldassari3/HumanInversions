...
# run_ztest_on_percentile("hapcount_SNPwindow/cleaned_autosomes_SNPwindow1000_SNPstep500_hapcount_snpden.tsv", 75, "NUM_uniq_haps", "SNP_density", 1000, "SNP Density of Windows in 75th Haplotype Count Percentile\nCompared to Whole Genome")
# run_ztest_on_percentile("hapcount_SNPwindow/cleaned_autosomes_SNPwindow1000_SNPstep500_hapcount_snpden.tsv", 90, "NUM_uniq_haps", "SNP_density", 1000, "SNP Density of Windows in 90th Haplotype Count Percentile\nCompared to Whole Genome")
# run_ztest_on_percentile("hapcount_SNPwindow/cleaned_autosomes_SNPwindow1000_SNPstep500_hapcount_snpden.tsv", 98, "NUM_uniq_haps", "SNP_density", 1000, "SNP Density of Windows in 98th Haplotype Count Percentile\nCompared to Whole Genome")


# run_ztest_on_coordinates("hapcount_SNPwindow/cleaned_autosomes_SNPwindow1000_SNPstep500_hapcount_snpden.tsv", inv_coords, "NUM_uniq_haps", 1000, "Haplotype Count for Inversion Windows\nCompared to Whole Genome")
# run_ztest_on_coordinates("hapcount_SNPwindow/cleaned_autosomes_SNPwindow1000_SNPstep500_hapcount_snpden.tsv", large_inv_coords, "NUM_uniq_haps", 1000, "Haplotype Count for Large Inversion (>1Mb) Windows\nCompared to Whole Genome")
# run_ztest_on_coordinates("hapcount_SNPwindow/cleaned_autosomes_SNPwindow1000_SNPstep500_hapcount_snpden.tsv", breakpoint_coords, "NUM_uniq_haps", 1000, "Haplotype Count for Inversion Breakpoint Windows\nCompared to Whole Genome")
# run_ztest_on_coordinates("hapcount_SNPwindow/cleaned_autosomes_SNPwindow1000_SNPstep500_hapcount_snpden.tsv", large_breakpoint_coords, "NUM_uniq_haps", 1000, "Haplotype Count for Large Inversion (>1Mb) Breakpoint Windows\nCompared to Whole Genome")
...
run_ztest_on_percentile("hapcount_BPwindow/cleaned_autosomes_BPwindow3000_BPstep1500_hapcount_snpden.tsv", 75, "NUM_uniq_haps", "SNP_density", 1000, "SNP Density of Windows in 75th Haplotype Count Percentile\nCompared to Whole Genome")
run_ztest_on_percentile("hapcount_BPwindow/cleaned_autosomes_BPwindow3000_BPstep1500_hapcount_snpden.tsv", 90, "NUM_uniq_haps", "SNP_density", 1000, "SNP Density of Windows in 90th Haplotype Count Percentile\nCompared to Whole Genome")
run_ztest_on_percentile("hapcount_BPwindow/cleaned_autosomes_BPwindow3000_BPstep1500_hapcount_snpden.tsv", 98, "NUM_uniq_haps", "SNP_density", 1000, "SNP Density of Windows in 98th Haplotype Count Percentile\nCompared to Whole Genome")



run_ztest_on_coordinates("hapcount_BPwindow/cleaned_autosomes_BPwindow3000_BPstep1500_hapcount_snpden.tsv", inv_coords, "NUM_uniq_haps", 1000, "Haplotype Count for Inversion Windows\nCompared to Whole Genome")
run_ztest_on_coordinates("hapcount_BPwindow/cleaned_autosomes_BPwindow3000_BPstep1500_hapcount_snpden.tsv", large_inv_coords, "NUM_uniq_haps", 1000, "Haplotype Count for Large Inversion (>1Mb) Windows\nCompared to Whole Genome")
run_ztest_on_coordinates("hapcount_BPwindow/cleaned_autosomes_BPwindow3000_BPstep1500_hapcount_snpden.tsv", breakpoint_coords, "NUM_uniq_haps", 1000, "Haplotype Count for Inversion Breakpoint Windows\nCompared to Whole Genome")
run_ztest_on_coordinates("hapcount_BPwindow/cleaned_autosomes_BPwindow3000_BPstep1500_hapcount_snpden.tsv", large_breakpoint_coords, "NUM_uniq_haps", 1000, "Haplotype Count for Large Inversion (>1Mb) Breakpoint Windows\nCompared to Whole Genome")
